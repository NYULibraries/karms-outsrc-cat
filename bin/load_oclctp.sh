...
echo "Script for loading OCLCtp vendor records"
echo ""
ls -l /exlibris/aleph/u22_2/nyu01/scratch/oclctp*.mrc
echo ""
...
csh -f p_manage_37 NYU01,ALEPH_SEQ,$fname2.q,000000000,000000000,$fname2.qfixed,OCLCT,N,SHADGETTR,OCLCTP,20,
...
echo "OCLCTP Techpro $fname2 file loaded [oclctp]" >> oclctploadrpt
...
mailx -s "OCLCtp records loaded- $fname2" aleph.notifications-group@nyu.edu,$emsub1 -- -f aleph.notifications-group@nyu.edu < oclctploadrpt
echo "Base filename is $fname2"
ls -lt /exlibris/aleph/u22_2/alephe/scratch/$fname2*
pwd
cat oclctploadrpt
echo "This OCLCtp load is done, done, done."
